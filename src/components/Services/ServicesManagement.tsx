  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-white">Services Catalog</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map(srv => (
          <div key={srv.id} className="glass-card p-5 rounded-2xl border-slate-850 flex flex-col justify-between hover:border-brand-500/30 transition-all">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold text-slate-400 bg-slate-900/60 border border-slate-850 px-2 py-0.5 rounded-md">
                  {srv.category}
                </span>
              ...
              <div className="flex items-center gap-4 text-xs font-semibold text-slate-300 pt-1">
                <span className="flex items-center gap-1"><Clock className="h-4 w-4 text-brand-400" /> {srv.duration} min</span>
            ...
            <div className="flex items-center justify-between gap-3 mt-6 pt-3 border-t border-slate-850">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="p-1.5 bg-slate-800 hover:bg-slate-700/80 text-slate-300 hover:text-white rounded-lg text-xs"
                >
